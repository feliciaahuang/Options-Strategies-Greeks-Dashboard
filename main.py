...
if T_init < 0:
    T_init = T
    print(f'T_init was invalid, default T value was used:{T}')

#check for any 0 values
print(S0_init, K_init, r_init, T_init, option_type_init,sigma_init)
#%%
...
#providing the templates to allow for easier execution and no need for manual calling
#%%
#COVERED CALL
#%%
pickstrat_plot(
